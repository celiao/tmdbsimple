...
![pypi](https://img.shields.io/pypi/pyversions/tmdbsimple?v=2.9.4)
![pypi](https://img.shields.io/pypi/v/tmdbsimple?v=2.9.4)
...
_Optionally_, configure the library to use bearer token authentication instead of the default API key query parameter. This may be useful if you encounter authorization issues with the default method.
