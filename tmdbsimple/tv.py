...
class TV_Episodes(TMDB):
    ...
    """
    BASE_PATH = 'tv/{id}/season/{season_number}/episode/{episode_number}'
    URLS = {
        'info': '',
        'credits': '/credits', 
        'external_ids': '/external_ids',
    ...
    def info(self, **kwargs):
        ...
        Returns:
            A dict respresentation of the JSON returned from the API.
        """
        path = self._get_id_season_number_episode_number_path('info')
    ...
    def credits(self, **kwargs):
        ...
        Returns:
            A dict respresentation of the JSON returned from the API.
        """
        path = self._get_id_season_number_episode_number_path('credits')
    ...
    def external_ids(self, **kwargs):
        ...
        Returns:
            A dict respresentation of the JSON returned from the API.
        """
        path = self._get_id_season_number_episode_number_path('external_ids')
    ...
    def images(self, **kwargs):
        ...
        Returns:
            A dict respresentation of the JSON returned from the API.
        """
        path = self._get_id_season_number_episode_number_path('images')
    ...
    def rating(self, **kwargs):
        ...
        Returns:
            A dict respresentation of the JSON returned from the API.
        """
        path = self._get_id_season_number_episode_number_path('rating')
    ...
    def videos(self, **kwargs):
        ...
        Returns:
            A dict respresentation of the JSON returned from the API.
        """
        path = self._get_id_season_number_episode_number_path('videos')
